...
def main(argv):
    ...
    meanFiringRate = 10 # spikes/sec
    C_filename = "data/00000000_C_3Latents_100Neurons.csv"
    d_filename = "data/00000000_d_100Neurons.csv"

    C_amplitude = math.log(maxFiringRate)
