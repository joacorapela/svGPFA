...
#                                                               location=location)
    ...
    spikes_times = loadRes["spikesTimes"][trial]
    time_fix_target = mat["Rb"][trial,location]["timeFixTarget"].squeeze()
    time_go_cue = mat["Rb"][trial,location]["timeGoCue"].squeeze()
    time_move_onset = mat["Rb"][trial,location]["timeMoveOnset"].squeeze()
    time_move_end = mat["Rb"][trial,location]["timeMoveEnd"].squeeze()
    title = title_pattern.format(trial, location)
    ...
    png_fig_filename = fig_filename_pattern.format(estResNumber, trial, "png")
    fig.write_image(png_fig_filename)
    html_fig_filename = fig_filename_pattern.format(estResNumber, trial, "html")
