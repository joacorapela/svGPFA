...
def main(argv):
    ...
    PyTorch_LBFGS_values = getPythonLowerBoundsAtConvergence(modelFilenames=fullModelsFilenames, convergenceTolerance=convergenceTolerance)
    ...
    for partialModelFilename in partialModelsFilenames:
        if not isinstance(partialModelFilename, numbers.Number):
            ...
            fullModelsFilenames.append(partialModelFilename)
    SciPy_L_BFGS_B_values = getPythonLowerBoundsAtConvergence(modelFilenames=fullModelsFilenames, convergenceTolerance=convergenceTolerance)
    ...
    for partialModelFilename in partialModelsFilenames:
        if not isinstance(partialModelFilename, numbers.Number):
            ...
            fullModelsFilenames.append(partialModelFilename)
    SciPy_trust_ncg_values = getPythonLowerBoundsAtConvergence(modelFilenames=fullModelsFilenames, convergenceTolerance=convergenceTolerance)
    ...
    Matlab_minFunc_values = getMatlabLowerBoundsAtConvergence(modelFilenames=fullModelsFilenames, convergenceTolerance=convergenceTolerance)
