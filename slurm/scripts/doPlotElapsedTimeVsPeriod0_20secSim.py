...
def main(argv):
    ...
    parser.add_argument("--descriptorsFilename", help="Name of file containing the descriptor of each line in the data files", default="../data/descriptors_20secSim_PyTroch_LBFGS.csv")
    ...
    fig.update_xaxes(title_text="Period Parameter Initial Condition")
    fig.update_yaxes(title_text="Elapsed Time (sec)")
