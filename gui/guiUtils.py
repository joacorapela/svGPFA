...
class svGPFA_runner:
    ...
    def run(self, 
        ...
        kmsParams0 = {"kernelsParams0": self.getKernelsParams0(), "inducingPointsLocs0": Z0}
        ...
        model = stats.svGPFA.svGPFAModelFactory.SVGPFAModelFactory.buildModel(conditionalDist=self.getConditionalDist(), linkFunction=self.getLinkFunction(), embeddingType=self.getEmbeddingType(), kernels=self.getKernels())
