...
def main(argv):
    ...
    parser.add_argument("--fig_filename_pattern",
                        ...
                        default="figures/{:08d}_PSTHfromExpectedPosteriorCIF_neuron{:d}_epoch{:s}.{:s}")
...
#                                                               location=location)
    ...
    psth_mean, psth_ci = stats.neuralDataUtils.computeAveragePSTH(spikes_times=spikes_times_numpy, neuron_index=neuron_index, trials_indices=trials_indices, epoch_times=epoch_times, bin_edges=psth_bin_edges, nResamples=psth_nResamples, alpha=psth_ci_alpha)
    ...
    fig = plot.svGPFA.plotUtilsPlotly.getPlotMeanWithCI(
        x=psth_bin_centers, mean=psth_mean, ci=psth_ci,
