...
def main(argv):
    ...
    ksTestTimeRescalingFigFilenamePattern = \
        "figures/{:08d}_simulation_ksTestTimeRescaling_trial{:03d}_neuron{:03d}.{{:s}}".format(simResNumber, exampleTrial, exampleNeuron)
...
#     fig = plot.svGPFA.plotUtilsPlotly.getSimulatedLatentsPlot(trialsTimes=times, latentsSamples=latents, latentsMeans=latentsMeans, latentsSTDs=latentsSTDs)
...
#     fig.show()
    ...
    fig = plot.svGPFA.plotUtilsPlotly.getSimulatedSpikesTimesPlot(spikesTimes=spikes)
