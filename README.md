...
In addition, after installing svGPFA, you can estimate models using a script, as shown in section [Testing the installation](#testing-the-installation) below. Examples running svGPFA on different dataset are provided in this [gallery](https://joacorapela.github.io/svGPFA/auto_examples/index.html).
